...
// Browser-supported and Google Fonts
const FONT_FAMILIES = [
  // System Fonts
  { value: "Arial, sans-serif", label: "Arial (System)" },
  { value: "Helvetica, sans-serif", label: "Helvetica (System)" },
  { value: "Times New Roman, serif", label: "Times New Roman (System)" },
  { value: "Georgia, serif", label: "Georgia (System)" },
  { value: "Courier New, monospace", label: "Courier New (System)" },
  { value: "Verdana, sans-serif", label: "Verdana (System)" },
  { value: "Tahoma, sans-serif", label: "Tahoma (System)" },
  { value: "Trebuchet MS, sans-serif", label: "Trebuchet MS (System)" },
  { value: "Impact, sans-serif", label: "Impact (System)" },
  { value: "Comic Sans MS, cursive", label: "Comic Sans MS (System)" },
  { value: "Lucida Console, monospace", label: "Lucida Console (System)" },
  { value: "Lucida Sans Unicode, sans-serif", label: "Lucida Sans Unicode (System)" },
  { value: "Palatino Linotype, serif", label: "Palatino Linotype (System)" },
  { value: "Garamond, serif", label: "Garamond (System)" },
  { value: "Book Antiqua, serif", label: "Book Antiqua (System)" },
  ...
  { value: "PT Sans, sans-serif", label: "PT Sans (Google)" },
  { value: "Droid Sans, sans-serif", label: "Droid Sans (Google)" },
  { value: "Nunito, sans-serif", label: "Nunito (Google)" },
  { value: "Inter, sans-serif", label: "Inter (Google)" },
  { value: "Work Sans, sans-serif", label: "Work Sans (Google)" },
  { value: "Fira Sans, sans-serif", label: "Fira Sans (Google)" },
  { value: "Noto Sans, sans-serif", label: "Noto Sans (Google)" },
  { value: "Muli, sans-serif", label: "Muli (Google)" },
  { value: "Quicksand, sans-serif", label: "Quicksand (Google)" },
  { value: "Rubik, sans-serif", label: "Rubik (Google)" },
  { value: "Cabin, sans-serif", label: "Cabin (Google)" },
  { value: "Dosis, sans-serif", label: "Dosis (Google)" },
  { value: "Josefin Sans, sans-serif", label: "Josefin Sans (Google)" },
  { value: "Libre Franklin, sans-serif", label: "Libre Franklin (Google)" },
  { value: "Maven Pro, sans-serif", label: "Maven Pro (Google)" },
  { value: "Nunito Sans, sans-serif", label: "Nunito Sans (Google)" },
  { value: "PT Sans Narrow, sans-serif", label: "PT Sans Narrow (Google)" },
  { value: "Titillium Web, sans-serif", label: "Titillium Web (Google)" },
  { value: "Yanone Kaffeesatz, sans-serif", label: "Yanone Kaffeesatz (Google)" },
  { value: "Barlow, sans-serif", label: "Barlow (Google)" },
  { value: "DM Sans, sans-serif", label: "DM Sans (Google)" },
  { value: "Manrope, sans-serif", label: "Manrope (Google)" },
  { value: "Plus Jakarta Sans, sans-serif", label: "Plus Jakarta Sans (Google)" },
  { value: "Space Grotesk, sans-serif", label: "Space Grotesk (Google)" },
  { value: "Figtree, sans-serif", label: "Figtree (Google)" },
  { value: "Outfit, sans-serif", label: "Outfit (Google)" },
  { value: "Sora, sans-serif", label: "Sora (Google)" },
  ...
  { value: "Crimson Text, serif", label: "Crimson Text (Google)" },
  { value: "PT Serif, serif", label: "PT Serif (Google)" },
  { value: "Source Serif Pro, serif", label: "Source Serif Pro (Google)" },
  { value: "Libre Baskerville, serif", label: "Libre Baskerville (Google)" },
  { value: "Bitter, serif", label: "Bitter (Google)" },
  { value: "Noto Serif, serif", label: "Noto Serif (Google)" },
  { value: "Roboto Slab, serif", label: "Roboto Slab (Google)" },
  { value: "Droid Serif, serif", label: "Droid Serif (Google)" },
  { value: "Arvo, serif", label: "Arvo (Google)" },
  { value: "Bree Serif, serif", label: "Bree Serif (Google)" },
  { value: "Crete Round, serif", label: "Crete Round (Google)" },
  { value: "Gentium Book Plus, serif", label: "Gentium Book Plus (Google)" },
  { value: "Lusitana, serif", label: "Lusitana (Google)" },
  { value: "Spectral, serif", label: "Spectral (Google)" },
  { value: "Vollkorn, serif", label: "Vollkorn (Google)" },
  
  // Google Fonts - Display/Decorative
  { value: "Bebas Neue, cursive", label: "Bebas Neue (Google)" },
  { value: "Righteous, cursive", label: "Righteous (Google)" },
  { value: "Fredoka One, cursive", label: "Fredoka One (Google)" },
  { value: "Lobster, cursive", label: "Lobster (Google)" },
  { value: "Pacifico, cursive", label: "Pacifico (Google)" },
  { value: "Dancing Script, cursive", label: "Dancing Script (Google)" },
  { value: "Satisfy, cursive", label: "Satisfy (Google)" },
  { value: "Kalam, cursive", label: "Kalam (Google)" },
  { value: "Permanent Marker, cursive", label: "Permanent Marker (Google)" },
  { value: "Shadows Into Light, cursive", label: "Shadows Into Light (Google)" },
  { value: "Amatic SC, cursive", label: "Amatic SC (Google)" },
  { value: "Bangers, cursive", label: "Bangers (Google)" },
  { value: "Chewy, cursive", label: "Chewy (Google)" },
  { value: "Comfortaa, cursive", label: "Comfortaa (Google)" },
  { value: "Fugaz One, cursive", label: "Fugaz One (Google)" },
  { value: "Indie Flower, cursive", label: "Indie Flower (Google)" },
  { value: "Luckiest Guy, cursive", label: "Luckiest Guy (Google)" },
  { value: "Monoton, cursive", label: "Monoton (Google)" },
  { value: "Orbitron, sans-serif", label: "Orbitron (Google)" },
  { value: "Russo One, sans-serif", label: "Russo One (Google)" },
  { value: "Sigmar One, cursive", label: "Sigmar One (Google)" },
  { value: "Titan One, cursive", label: "Titan One (Google)" },
  
  // Google Fonts - Monospace
  { value: "Roboto Mono, monospace", label: "Roboto Mono (Google)" },
  { value: "Source Code Pro, monospace", label: "Source Code Pro (Google)" },
  { value: "Fira Code, monospace", label: "Fira Code (Google)" },
  { value: "Fira Mono, monospace", label: "Fira Mono (Google)" },
  { value: "Inconsolata, monospace", label: "Inconsolata (Google)" },
  { value: "PT Mono, monospace", label: "PT Mono (Google)" },
  { value: "Space Mono, monospace", label: "Space Mono (Google)" },
  { value: "Courier Prime, monospace", label: "Courier Prime (Google)" },
  { value: "JetBrains Mono, monospace", label: "JetBrains Mono (Google)" },
  { value: "IBM Plex Mono, monospace", label: "IBM Plex Mono (Google)" },
  
  // Google Fonts - Handwriting
  { value: "Caveat, cursive", label: "Caveat (Google)" },
  { value: "Caveat Brush, cursive", label: "Caveat Brush (Google)" },
  { value: "Gloria Hallelujah, cursive", label: "Gloria Hallelujah (Google)" },
  { value: "Gochi Hand, cursive", label: "Gochi Hand (Google)" },
  { value: "Handlee, cursive", label: "Handlee (Google)" },
  { value: "Patrick Hand, cursive", label: "Patrick Hand (Google)" },
  { value: "Shadows Into Light Two, cursive", label: "Shadows Into Light Two (Google)" },
];
